...
function! edumag2#set_highlight(group, style)
  call s:h(a:group, a:style)
endfunction

function! edumag2#extend_highlight(group, style)
...
call s:h("Identifier", { "fg": s:dark_yellow }) " any variable name
...
call s:h("phpUseClass", { "fg": s:blue })
